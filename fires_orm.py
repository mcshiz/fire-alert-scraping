...
class Fires(Base):
    ...
    def __init__(self, lat=None, lon=None, name=None, status=None, unit_code=None, acres=None,
                 ...
                 fire_number=None, initial_attack_acres=None, official_acres=None, fuel_type=None, land_owner=None,
                 life_threatened=None, structures_threatened=None, road_closures=None, evacuations=None,
        ...
        self.acres = acres
        self.inciweb_published_date = inciweb_published_date
